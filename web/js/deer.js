 ...
 */
async function getTemplate(obj, typeOverride, options) {
...
function renderProp(obj, options) {
...
function renderJSON(obj, options) {
...
function renderEntity(obj, options = {}) {
...
function renderPerson(obj, options = {}) {
    try {
...
function renderEvent(obj, options) {
    let elem = ``
    try {
        return elem
    } catch (err) {
